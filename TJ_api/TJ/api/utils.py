...
def get_encoded_faces():
    ...
    for p in qs:
        ...
        # Check if the profile_path attribute has an associated file
        if p.profile_path and p.profile_path.name:
            try:
                # Load the user's profile image
                face = fr.load_image_file(p.profile_path.path)
